    ...
    <div class="container" >
        <div class="row">
            <div class = "col-md-4 col-md-offset-4">
                <span class="cent"> Add Project <i class="fa fa-plus fa-5x"  aria-hidden="true"></i></span>
                <span class="cent">Edit Project <i class="fa fa-pencil-square-o fa-5x" aria-hidden="true"></i></span>


            </div>
            <div class = "col-md-4 col-md-offset-4">
                <span class="cent"> View Projects <i class="fa fa-list fa-5x" aria-hidden="true" ></i></span>
                <span class="cent">Edit Profile <i class="fa fa-wrench fa-5x" aria-hidden="true"></i></span>
